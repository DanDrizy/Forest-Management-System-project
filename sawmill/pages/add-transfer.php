...
<div class="container">
    <h1>Tree Transfer Registration</h1>
    <form id="harvestForm" method="post" action="../backend/add-transfer-backend.php">
        <div class="form-group">
            ...
            <select name="log_id" id="tree_selection" required>
                ...
                $select_logs = $pdo->prepare("SELECT

                logs_records.cutted_trees,
                logs_records.date,
                logs_records.log_id,
                logs_records.tree_id,
                logs_records.tree_name,
                logs_records.volume,
                logs_records.measure,
                logs_records.location

                from logs_records,sawmill_trees_records,sawmill_transfer_records where logs_records.tree_id = sawmill_trees_records.tree_id
                AND sawmill_trees_records.tree_id = sawmill_transfer_records.tree_id AND sawmill_transfer_records.send = 'unactive'");
                $select_logs->execute();
                $logs = $select_logs->fetchAll(PDO::FETCH_ASSOC);
        ...
        <div class="button-group">
            <button type="button" id="clearBtn"><a href="transfer.php" style=" text-decoration: none; color: #333; " ><i class="fa fa-arrow-circle-left"> </i> Back</a></button>
