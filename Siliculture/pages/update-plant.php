    ...
    <div class="main-content">
        <div class="container">
            <div class="page-header">
                <h1 class="page-title">Update Tree</h1>

            </div>

            <div class="form-container">
                <h2 class="form-title">Tree Information to Update</h2>

                <form id="addUserForm" method="post" action="../backend/update-plant-backend.php" enctype="multipart/form-data">
                    <div class="form-row">
                        <div class="form-group">
                            <label for="firstName" >Tree Name</label>
                            <input class="form-control"  class="form-control"  type="hidden" name="id" id="p_name" value="<?php echo $data[0]['p_id']; ?>" required>
                            <input class="form-control"  class="form-control"  type="text" name="p_name" id="p_name" value="<?php echo $data[0]['p_name']; ?>" required>
                        </div>

                        <div class="form-group">
                            <label for="lastName" >Country</label>
                            <input class="form-control"  class="form-control"  type="text" name="country" value="<?php echo $data[0]['country']; ?>" id="country"  required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input class="form-control"  type="text" name="provance" value="<?php echo $data[0]['provance']; ?>" id="provance" required>
                        </div>

                        <div class="form-group">
                            <label >Location</label>
                            <input class="form-control"  type="text" name="location" value="<?php echo $data[0]['location']; ?>" id="location" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="tree-type">
                            ...
                            <div class="autocomplete-container">
                                <input class="form-control"  type="text" id="tree-type-search" class="form-control"  value="<?php $type = $data[0]['tree_type'] ? $data[0]['tree_type'] : ''; echo $type; ?>" required>
                                <input class="form-control"  class="form-control"  type="hidden" name="tree-type" id="tree-type" required>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="comment">
                                ...
                                <textarea name="comment" id="comment" class="comment-input"><?php echo $data[0]['comment']; ?></textarea>
                            </div>
                        </div>
                    </div>
